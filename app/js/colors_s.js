 ...
 *
 * @log
 * - 20130502 @spolu    Refactoring as an angular service
...
angular.module('breach.services').
  ...
  var x11_to_css = function(v) {
    ...
    var ary = v.match(re_.x11rgb);
    if (!ary)
      return name_to_rgb(v);
    ary.splice(0, 1);
    return array_to_rgba(ary.map(scale));
  };
  ...
  //
  var array_to_rgba = function(ary) {
  ...
  var _colors = {
    re_: re_,
    rgb_to_x11: rgb_to_x11,
    x11_to_css: x11_to_css,
    hex_to_rgb: hex_to_rgb,
    array_to_rgba: array_to_rgba,
    name_to_rgb: name_to_rgb,
    palette: palette
  };
