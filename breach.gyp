  ...
  'targets': [
    {
      ...
      'mac_bundle_resources!': [
        ...
        'breach/mac/Info.plist',
      ],
      'xcode_settings': {
        'INFOPLIST_FILE': 'breach/mac/Info.plist',
      ...
      'targets': [
        {
          ...
          'xcode_settings': {
            'INFOPLIST_FILE': 'breach/mac/helper-Info.plist',
            # Necessary to avoid an "install_name_tool: changing install names or
            # rpaths can't be redone" error.
            'OTHER_LDFLAGS': ['-Wl,-headerpad_max_install_names'],
            'SYMROOT': 'xcodebuild',
