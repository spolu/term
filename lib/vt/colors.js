...
//
// ### Colors Regular Expressions
// Used for parsing and transofrmation of color codes
//
exports.re_ = {
  // CSS hex color, #RGB.
...
// ### rgb_to_x11
// ```
// @value {string} The CSS color value to convert.
// @return {string} The X11 color value or null
// ```
// Convert a CSS rgb(ddd,ddd,ddd) color value into an X11 color value.
//
exports.rgb_to_x11 = function(value) {
  function scale(v) {
  ...
  var ary = value.match(exports.re_.rgbx);
  if (!ary)
    return null;
...
// ### x11_to_css
// ```
// @value {string} The X11 color value to convert.
// @return {string} The CSS color value or null
// ```
...
exports.x11_to_css = function(v) {
  ...
  var ary = v.match(exports.re_.x11rgb);
  if (!ary)
    return exports.name_to_rgb(v);
  ary.splice(0, 1);
  return exports.array_to_rgba(ary.map(scale));
};

//
// ### hex_to_rgb
// ```
// @arg {string|array} Single RGB value or array of RGB values to convert.
// @return {string|array} The converted value or values.
// ```
// Converts one or more CSS '#RRGGBB' color values into their rgb(...) form.
// 
exports.hex_to_rgb = function(arg) {
  function convert(hex) {
    var re = (hex.length == 4) ?
        exports.re_.hex16 : exports.re_.hex24;
...
// ### array_to_rgba
// ```
// @ary {array} the array of component values
// @return {string} the rgba string value
// ```
// Convert a 3 or 4 element array into an rgba(...) string.
//
exports.array_to_rgba = function(ary) {
...
// ### name_to_rgb
// ```
// @name {string} The color name to convert.
// @return {string} The corresponding CSS rgb(...) value.
// ```
// Convert an X11 color name into a CSS rgb(...) value.
//
exports.name_to_rgb = function(name) {
  if (name in exports.color_names)
    return exports.color_names[name];
...
// ### stock_color_palette
//
exports.stock_color_palette = exports.hex_to_rgb
([// The "ANSI 16"...
...
//
exports.color_palette = exports.stock_color_palette;
