...
var term = function(spec, my) {
  ...
  init = function() {
    ...
    my.vt.on('set_auto_carriage_return', function(state) {
    ...
    my.vt.on('set_scroll_region', function(top, bottom) {
      if(top) my.scroll.top = common.clamp(0, my.geometry[1] - 1);
      if(bottom) my.scroll.bottom = common.clamp(0, my.geometry[1] - 1);
    });
